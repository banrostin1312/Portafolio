        ...
        <div className="flex flex-col items-center bg-black bg-opacity-65 max-w-full rounded-xl md:mt-0 ">
          ...
          <div className="flex flex-col gap-10 md:flex-row text-white text-xl mb-8">
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <Image src="/assets/certificado-henry.png" alt="henry" height={400} width={350}
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <Image src="/assets/certificado-ingles.png" alt="henry" height={400} width={350}
                className="hover:scale-110 transform transition-transform duration-300"
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <Image src="/assets/certificado-gac.jpeg" alt="henry" height={400} width={350}
                className="hover:scale-110 transform transition-transform duration-300"
          ...
          <div className="flex flex-col text-center text-white space-y-4 p-3 ">
            ...
            <div className="flex flex-row gap-2 justify-center items-center">
              <Image src="/assets/github-icon.png" alt="github" height={40} width={40} />
            ...
            <div className="flex flex-row gap-2 justify-center items-center">
              <Image src="/assets/linkedin-icon.png" alt="github" height={40} width={40} />
            ...
            <div className="flex flex-row gap-2 justify-center items-center">
              <Image src="/assets/email-icon.png" alt="github" height={40} width={40} />
